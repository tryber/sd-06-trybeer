...
const createDataBase = () => {
  const createDataBaseQuery = 'CREATE DATABASE IF NOT EXISTS Trybeer;';
  return createDataBaseQuery;
};

const createTableUsers = () => {
  const createTableUsersQuery = `CREATE TABLE Trybeer.users (
  ...
  return createTableUsersQuery;
};

const createTableSales = () => {
  const createTableSalesQuery = `CREATE TABLE Trybeer.sales (
    id INT NOT NULL AUTO_INCREMENT,
  ...
  return createTableSalesQuery;
};

const createTableProducts = () => {
  const createTableProductsQuery = `CREATE TABLE Trybeer.products (
    id INT NOT NULL AUTO_INCREMENT,
    name VARCHAR(100) NOT NULL,
  ...
  return createTableProductsQuery;
};

const createTableSalesProducts = () => {
  const createTableSalesProductsQuery = `CREATE TABLE Trybeer.sales_products (
  ...
  return createTableSalesProductsQuery;
};

const insertUsers = () => {
  const insertUsersQuery = `INSERT INTO Trybeer.users (id, name, email, password, role)
    VALUES
      ('1', 'Tryber Admin', 'tryber@trybe.com.br', '123456', 'administrator'),
      ('2', 'Bruno Silva Batista', 'bruno.batista@gmail.com', '12345678', 'client');`;

  return insertUsersQuery;
};

const insertProductsQuery = `INSERT INTO Trybeer.products (id, name, price, url_image)
VALUES ('1','Skol Lata 250ml',2.20,
...
const insertProducts = () => insertProductsQuery;
